...
#cd "${PROJECT_PATH}"
#cordova-paramedic --platform android --plugin plugins/cordova-plugin-appsflyer-sdk --outputDir "${HOME}"/projects/Dev/appsflyer-cordova-plugin/examples/cordovatestappold/testResults --verbose --target "${EMULATOR_ID}"
...
DIR=$(pwd)
cordova-paramedic --platform ios --plugin plugins/cordova-plugin-appsflyer-sdk --outputDir "${DIR}"/testResults/ios --verbose
